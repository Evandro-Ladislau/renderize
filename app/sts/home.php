...
<body id="page-top">
    ...
    $sts_situacoe = 1;
    $cmd = $pdo->prepare("SELECT * FROM sts_masthead WHERE 
               sts_situacoe_id = :sts_situacoe ");
    $cmd->bindValue(':sts_situacoe', $sts_situacoe, PDO::PARAM_INT);
    $cmd->execute();
            ...
            ?>
                    <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center <?php echo $result_masthead[$i]['posicao_text'] ?> ">
                        ...
                        <div class="col-lg-8 align-self-baseline">
                            ...
                            <a class="btn btn-primary btn-xl" href="#contactForm"><?php echo $result_masthead[$i]['titulo_botao'] ?></a>
                        </div>
                        </div>
            ...
            <div class="row g-0 card-about">
                <div class="col-lg-6 col-sm-6">
                    <p class="text-black">Da paixão por tecnologia nasceu a Application Web,
                        ...
                        <a target="_blanck" href="https://www.linkedin.com/in/evandro-ladislau/" class=" text-muted mr-4">
